...
class NfcProcess extends StatefulWidget {
  @override
  _NfcProcessState createState() => _NfcProcessState();
}

class _NfcProcessState extends State<NfcProcess> {
  @override
            ...
            Padding(
              ...
              child: Column(
                children: [
                  Image(
                    height: 300,
                    image: AssetImage("assets/images/nfc_process.png"),
                  ),
